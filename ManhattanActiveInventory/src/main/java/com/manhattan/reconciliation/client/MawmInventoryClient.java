...
/**
 * Client interface for interacting with the Manhattan Active Warehouse Management (MAWM) system.
 */
public interface MawmInventoryClient {
     ...
     * @return The inventory record from MAWM system
     */
